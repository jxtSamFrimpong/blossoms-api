dictionary = {
    ...
    "yahwe": "A modern transliteration of the Hebrew word translated Jehovah in the Bible; -- used by some critics to discriminate the tribal god of the ancient Hebrews from the Christian Jehovah. Yahweh or Yahwe is the spelling now generally adopted by scholars.",
    "solisequious": "Following the course of the sun; as, solisequious plants. [R.] Sir T. Browne.",
    "saline": "1. Consisting of salt, or containing salt; as, saline particles; saline substances; a saline cathartic. 2. Of the quality of salt; salty; as, a saline taste.\n\nA salt spring; a place where salt water is collected in the earth.\n\n1. (Chem.)  A crude potash obtained from beet-root residues and other similar sources. [Written also salin.] 2. (Med. Chem.)  A metallic salt; esp., a salt of potassium, sodium, lithium, or magnesium, used in medicine.",
    ...
    "pyrothonide": "A kind of empyreumatic oil produced by the combustion of textures of hemp, linen, or cotton in a copper vessel, -- formerly used as a remedial agent. Dunglison.",
    ...
    "lenient": "1. Relaxing; emollient; softening; assuasive; -- some \"Lenient of grief.\" Milton. Of relax the fibers, are lenient, balsamic. Arbuthnot. Time, that on all things lays his lenient hand. Pope. 2. Mild; clement; merciful; not rigorous or severe; as, a lenient disposition; a lenient judge or sentence.\n\nA lenitive; an emollient.",
    "massage": "A rubbing or kneading of the body, especially when performed as a hygienic or remedial measure.",
    "owler": "One who owls; esp., one who conveys contraband goods. See Owling, n. [Obs. or Prov. Eng.] T. Brown.",
    "selenic": "Of or pertaining to selenium; derived from, or containing, selenium; specifically, designating those compounds in which the element has a higher valence as contrasted with selenious compounds.",
